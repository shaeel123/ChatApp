...
const MiddleBox = () => {
  {/* 4*/}
  const { userData, chatUser, setChatUser , showProfile, setShowProfile } = useAppContext()
  ...
  return (
    <div className='chat-box'>
      <div className="chat-user">
        {/* mobile back button code */}         1
        <div className="mobile-back-btn" onClick={() => setChatUser(null)} title="Back">
